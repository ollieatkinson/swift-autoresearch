...
| cycle | strategy | held-out score | selected claim |
| --- | --- | ---: | --- |
| 0 | naive top-category comparison | `0.000000` | Harrogate violent-crime share higher than Northallerton |
| 1 | largest raw share gap | `1.203788` | Scarborough violent-crime share higher than York |
| 2 | thresholded significance plus lift | `6.027808` | York bicycle-theft share higher than Scarborough |
...
than a random discovery-positive claim.
